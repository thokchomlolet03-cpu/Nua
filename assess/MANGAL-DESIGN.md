...
- Each generated inquiry item includes an editable response contract that names the evidence components to show without supplying the conclusion. The learner may answer with concise prose, a labelled list or a table. Type-relevant glossary terms use plain-language definitions; they are access support, not conceptual answers. The three pacing checkpoints suggest natural pauses after questions 8 and 16 while retaining the full 20-question requirement.
